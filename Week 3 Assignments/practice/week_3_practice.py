...
# BONUS
def doCirclesIntersect(x1, y1, r1, x2, y2, r2):
    # return True if the circle centered at (x1, y1) with radius r1
    # intersects the circle centered at (x2, y2) with radius r2
    # return False otherwise
...
def testAll():
    ...
    # you can also add your own tests here!
    return
